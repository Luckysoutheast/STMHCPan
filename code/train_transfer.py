...
train_file = '../data/train_set/Transfer/neo_train_data.csv'
val_file = '../data/train_set/Transfer/neo_val_data.csv'
...
class Trainer():
    def __init__(self, model):
        ...
        # criterion
        self.criterion = nn.CrossEntropyLoss(weight=torch.FloatTensor([2, 1, 1, 1, 1, 1])).to(device)
        ...
        # optimizer
        self.optimizer = optim.Adam(Adam_LLRD(model), betas=(0.9,0.98), eps=1e-09)
    ...
    def train(self):
        ...
        for epoch in range(1, epochs + 1):
            ...
            if self.best_dev_auc <= dev_auc:
                ...
                torch.save(self.model.state_dict(), f'./work/model_f1_{dev_auc}_{epoch}.bin')
